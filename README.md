<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=24&duration=3000&pause=1000&color=3366CC&center=true&vCenter=true&width=550&lines=Hi+%F0%9F%91%8B%2C+I'm+Bhavesh+Jangir;Software+Engineer;AI+%26+Generative+AI+Developer;Python+%7C+Angular+%7C+Android" alt="Typing SVG" />
</div>

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=bhaveshjangir&label=Profile%20Views&color=0e75b6&style=flat-square" alt="bhaveshjangir" />
</p>
...
I am a **Software Engineer** bridging the gap between mobile engineering and modern **Artificial Intelligence**.
* **Current Focus:** Building Gen AI agents, LLM-powered applications, and Full Stack Web (Angular).
* **Background:** extensive experience in Android App Development (Java/Kotlin).
* **Goal:** To leverage AI to solve complex, real-world user problems.
...
#### 🐮 [CowCare - Balaji Guashala](https://play.google.com/store/apps/details?id=com.twodev.hamarigaushala)
> *An Android application deployed to the Google Play Store.*
* **Impact:** Digitalizes resources for Gaushala management.
* **Tech Stack:** Android Native (Java/Kotlin), Firebase Database.
